...
namespace GEngine {
	...
	void Material::AllocateStorage()
	{
		if (m_Shader->HasVSMaterialUniformBuffer())
		{
			...
			m_VSUniformStorageBuffer.MemSetZero();
		}
		...
		if (m_Shader->HasPSMaterialUniformBuffer())
		{
			...
			m_PSUniformStorageBuffer.MemSetZero();
		}
	}
	...
	Buffer& Material::GetUniformBufferTarget(ShaderUniformDeclaration* uniformDeclaration)
	{
		...
		GE_CORE_ASSERT(false, "Invalid uniform declaration domain! Material does not support this shader type.");
