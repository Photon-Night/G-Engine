...
namespace GEngine {
    ...
    struct Ray
    {
        ...
        bool IntersectsAABB(const BoundingBox& BoundingBox, float& t) const
        {
            ...
            // lb is the corner of BoundingBox with minimal coordinates - left bottom, rt is maximal corner
            // r.org is origin of ray
            const glm::vec3& lb = BoundingBox.Min;
            const glm::vec3& rt = BoundingBox.Max;
