...
typedef struct GLFWvidmode
{
     ...
     */
    int blueBits;
    /*! The refresh rate, in GE, of the video mode.
     */
    int refreshRate;
} GLFWvidmode;
 ...
 *  area or video mode.
 *  @param[in] refreshRate The desired refresh rate, in GE, of the video mode,
 *  or `GLFW_DONT_CARE`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
...
/*! @brief Returns the frequency, in GE, of the raw timer.
 *
 *  This function returns the frequency, in GE, of the raw timer.
 *
 *  @return The frequency of the timer, in GE, or zero if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
